  ...
  Drupal.behaviors.postCodeAnywhere = {
    attach: function () {
      ...
      if ($(Drupal.settings.postcodeanywhere.id_wrapper)) {
        ...
        var addressfield = $('.field-type-engage-address-field');
             ...
             // $(pca_output_div).slideUp('Slow');
              ...
              $.getJSON(Drupal.settings.basePath + "pca/retrievebyid/" + pca_id, function(data){
               if (data.length > 0 && data['error'] == null) {
                 ...
                 addressfield.find('#edit-field-engage-collection-address-und-address-line-1').val(data[0].Company[0]);
                 addressfield.find('#edit-field-engage-collection-address-und-address-line-2').val(data[0].Line2[0]);
                 addressfield.find('#edit-field-engage-collection-address-und-county').val(data[0].County[0]);
                 addressfield.find('#edit-field-engage-collection-address-und-town').val(data[0].PostTown[0]);
                 addressfield.html('<p class="thoroughfare pca-text">'+ data[0].Company[0] +'</p><p class="premise pca-text">'+  data[0].Line2[0] + '</p><p class="premise pca-text">'+ data[0].PostTown[0] +'</p><p class="postal-code pca-text">'+ data[0].Postcode[0] +'</p><p class="pca-change-address"><a href="#">Change Address</a></p>');
